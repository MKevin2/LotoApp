...
class Mega : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        etJogos = findViewById(R.id.etNumMega)
        etQtd = findViewById(R.id.etJogosMega)
        btGerarJogos = findViewById(R.id.btGerarMega)
        tvResultado = findViewById(R.id.tvResultadoMega)
        tvJogos = findViewById(R.id.tvJogoMega)
        ...
        btGerarJogos.setOnClickListener {
            ...
            if (inputTextoQtd.isNotEmpty() && inputTextoJogos.isNotEmpty()) {
                ...
                if (quantidadeJogos > 0 && quantidadeNumeros in 6..20) {
                    if (listaDeJogos.isEmpty()) {
                        for (i in 1..quantidadeJogos) {
                            val jogo = (1..60).shuffled().take(quantidadeNumeros).sorted()
                    ...
                    Toast.makeText(this, "A quantidade de números por jogo deve ser entre 6 e 20!", Toast.LENGTH_LONG).show()
                }
            } else {
